...
bounded between a floor and a cap; changes are gated by a minimum-change threshold and limited by a maximum per-update step size, preventing rapid oscillations. Within that infrastructure,  
